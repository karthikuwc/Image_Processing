...
class LBTHuffman(HuffmanHelper):
    """Helper Class for LBT Compression and Huffman coding"""

    def lbthuffenc(self, X, qstep, N=8, M=8, opthuff=False, dcbits=8, scale=1.3435, log=False):
        if M % N != 0:
    ...
    def lbthuffdec(self, vlc, qstep, N=8, M=8, bits=None, huffval=None, dcbits=8, W=256, H=256, scale=1.34, log=False):
        '''
